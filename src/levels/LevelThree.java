...
public class LevelThree {
	...
	public static Map3 map = new Map3();
	public static EnemyOne VE = new EnemyOne(200,500,0,3);//bb
	public static EnemyOne VE2 = new EnemyOne(1280,100,0,3);//bb
	public static EnemyOne VE3 = new EnemyOne(1320,500,0,3);//bb
	public static EnemyOne VE4 = new EnemyOne(1360,300,0,3);
	public static EnemyOne HE = new EnemyOne(100,740,3,0);
	public static EnemyOne HE2 = new EnemyOne(300,640,3,0);
	public static EnemyOne HE3 = new EnemyOne(500,520,3,0);//bb
	public static EnemyOne HE4 = new EnemyOne(700,420,3,0);//bb12
	public static EnemyOne HE5 = new EnemyOne(900,280,3,0);//8
	public static Exit exit = new Exit(760,240);
	public static Player player = new Player(80,100);
	...
	public static void Collision(){
        ...
        Rectangle d9 = new Rectangle(VE3.x,VE3.y,25,25);
        ...
        if(p.intersects(e)){
        	game.PaintComponent.levelThree = false;
        	game.PaintComponent.levelFour = true;
        }
